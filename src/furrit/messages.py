...
The messages in this chat assume that the messages are being sent with the
MarkdownV2 parse mode and are escaped accordingly.

WARNING! Make sure you escape the characters described in the Telegram API
Documentation (under MarkdownV2):
https://core.telegram.org/bots/api#formatting-options
"""

LINKS_MESSAGE = r"""**Links:**
Greater Rochester Area Resources
...
CHATS_MESSAGE = r"""**Furrit Channels:**
...
CHANNELS_SFW_MESSAGE = r"""SFW Affiliated Chats and Channels
Run by FurRIT members rather than the Admin Team\. Subject to their own rules\.

Azu \(http://t\.me/azu\_shorttail\)
...
CHANNELS_NSFW_MESSAGE = r""""""

COMMANDS_MESSAGE = r"""The list of user commands for the Bot:
